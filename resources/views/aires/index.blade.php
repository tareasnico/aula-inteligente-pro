    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-blue-600 rounded-lg shadow-lg p-6 mb-8 text-white flex items-center justify-between">
                <div>
                    <h3 class="text-3xl font-bold">Panel de Climatización</h3>
                    <p class="mt-1 text-blue-100">Administra los equipos de aire acondicionado y su estado.</p>
                </div>
                <svg class="h-16 w-16 text-blue-300 opacity-75" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12H3m18 0h-2M12 5V3M12 21v-2M18.364 5.636L16.95 7.05M7.05 16.95l-1.414 1.414M18.364 18.364L16.95 16.95M7.05 7.05L5.636 5.636"/>
                </svg>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg border border-gray-200">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('aires.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 transition ease-in-out duration-150">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Próx. Mantenimiento</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                                        ...
                                        <td class="px-6 py-4 text-right text-sm font-medium">
                                            <form action="{{ route('aires.destroy', $aire) }}" method="POST">
                                                <a href="{{ route('aires.edit', $aire) }}" class="inline-flex items-center text-blue-600 hover:text-blue-900 mr-4 transition duration-150 ease-in-out">
                                ...
                                @empty
                                    <tr><td colspan="5" class="px-6 py-4 text-center text-gray-500">No hay equipos registrados.</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
